      ...
      <main className="container px-4 py-8">
        ...
        <section className="grid md:grid-cols-2 gap-8 items-center mb-12">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              ...
              visual, tetapi juga memiliki makna mendalam bagi setiap individu.
            </p>
            <p className="text-gray-600 mb-4">
              ...
              islami yang menginspirasi. Setiap produk kami dirancang dengan
              penuh perhatian terhadap detail dan kualitas, memastikan bahwa
              setiap pelanggan mendapatkan yang terbaik untuk meningkatkan
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 mb-4">
            ...
            utama dalam meningkatkan spiritualitas masyarakat Indonesia,
          ...
          <ul className="list-disc list-inside text-gray-600 mb-4">
            ...
            <li>
              Menjadi katalis dalam meningkatkan literasi Al-Qur'an di
              masyarakat
            </li>
            <li>
        ...
        <section className="mb-12">
          ...
          <ol className="list-decimal list-inside text-gray-600 mb-4">
            ...
            <li>
              ...
              yang terjangkau, memastikan setiap muslim di Surabaya dan
              sekitarnya dapat mengakses produk-produk yang meningkatkan
              kualitas ibadah mereka.
            </li>
            <li>
              Melakukan inovasi berkelanjutan dalam desain dan produksi,
              mengikuti perkembangan tren dan kebutuhan pasar tanpa
              mengesampingkan nilai-nilai islami.
            </li>
            <li>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            ...
            menyediakan Al-Qur'an custom cover dan perlengkapan ibadah
            berkualitas dengan harga terjangkau di Surabaya, kami tidak hanya
            menjalankan bisnis, tetapi juga berkontribusi pada peningkatan
